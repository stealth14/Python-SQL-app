...
#controles
    ...
    global tipo_usuario
    tipo_usuario = bool_usuario

    global bool_nota1,bool_nota2,bool_nota3
    global c,d,e,var_codigo,var_nota,nombre,nota,insert,var_resultados,lbl_resultados,delete,btn_peores10,btn_mejores10,btn_promedio_general,btn_promedios_individuales,btn_promedios_individuales,btn_promedios_individuales
